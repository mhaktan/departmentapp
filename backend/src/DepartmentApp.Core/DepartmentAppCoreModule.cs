...
{
    public class DepartmentAppCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            Configuration.DefaultNameOrConnectionString = string.IsNullOrEmpty(envConnStr)
                ? DepartmentAppConsts.ConnectionStringName
                : envConnStr;
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DepartmentAppCoreModule).GetAssembly());
        }
    }
}
