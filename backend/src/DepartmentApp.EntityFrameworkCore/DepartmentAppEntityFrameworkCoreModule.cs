...
{
    [DependsOn(typeof(DepartmentAppCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class DepartmentAppEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<DepartmentAppDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DepartmentAppEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
