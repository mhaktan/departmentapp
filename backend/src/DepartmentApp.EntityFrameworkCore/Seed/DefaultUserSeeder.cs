    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "Requester", DisplayName = "Talep Eden", Description = "Satın alma talebi oluşturur, kendi taleplerini görür ve düzenler.", IsSystem = false, IsActive = true };
                ...
                {
                    customRole_2 = new AppRole { Name = "FinanceApprover", DisplayName = "Finans Onaycısı", Description = "Birim müdürü onaylı talepleri finans açısından değerlendirir, onaylar veya reddeder.", IsSystem = false, IsActive = true };
                ...
                {
                    customRole_3 = new AppRole { Name = "PurchasingOfficer", DisplayName = "Satın Alma Sorumlusu", Description = "Onaylı taleplere teklif ekler, seçim yapar ve sipariş oluşturur.", IsSystem = false, IsActive = true };
                ...
                Console.WriteLine("[Seed] Step 9: Custom role 'PurchasingManager'");
                var customRole_4 = _roleRepo.GetAll().FirstOrDefault(r => r.Name == "PurchasingManager");
                if (customRole_4 == null)
                {
                    customRole_4 = new AppRole { Name = "PurchasingManager", DisplayName = "Satın Alma Müdürü", Description = "Satın alma sorumlusunun oluşturduğu siparişleri inceler ve onaylar.", IsSystem = false, IsActive = true };
                    customRole_4.Id = _roleRepo.InsertAndGetId(customRole_4);
                    Console.WriteLine($"[Seed] Created custom role 'PurchasingManager' (id={customRole_4.Id})");
                }
                var customPerms_4 = new string[] { "PurchaseOrder.Read", "PurchaseOrder.ChangeStatus", "PurchaseRequest.Read", "Quotation.Read", "Supplier.Read" };
                ...
                {
                    if (!allPermSet_4.Contains(pn)) { Console.WriteLine($"[Seed] Skipping unknown permission '{pn}' for role 'PurchasingManager'"); continue; }
