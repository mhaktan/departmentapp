...
import { DisciplinaryRecordList } from './DisciplinaryRecordList';
...
describe('DisciplinaryRecordList', () => {
  it('should render without crashing', () => {
    const { container } = render(<DisciplinaryRecordList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<DisciplinaryRecordList />, { wrapper });
    expect(screen.getByText('DisciplinaryRecord')).toBeDefined();
  });

  it('should have create button', () => {
    render(<DisciplinaryRecordList />, { wrapper });
    expect(screen.getByText('+ Create DisciplinaryRecord')).toBeDefined();
  });
