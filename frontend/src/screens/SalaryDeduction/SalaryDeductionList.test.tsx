...
import { SalaryDeductionList } from './SalaryDeductionList';
...
describe('SalaryDeductionList', () => {
  it('should render without crashing', () => {
    const { container } = render(<SalaryDeductionList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<SalaryDeductionList />, { wrapper });
    expect(screen.getByText('SalaryDeduction')).toBeDefined();
  });

  it('should have create button', () => {
    render(<SalaryDeductionList />, { wrapper });
    expect(screen.getByText('+ Create SalaryDeduction')).toBeDefined();
  });
