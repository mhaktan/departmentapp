...
describe('JobApplicationList', () => {
  it('should render without crashing', () => {
    const { container } = render(<JobApplicationList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<JobApplicationList />, { wrapper });
    expect(screen.getByText('JobApplication')).toBeDefined();
  });

  it('should have create button', () => {
    render(<JobApplicationList />, { wrapper });
    expect(screen.getByText('+ Create JobApplication')).toBeDefined();
  });
