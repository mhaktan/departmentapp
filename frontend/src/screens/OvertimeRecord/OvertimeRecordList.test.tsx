...
import { OvertimeRecordList } from './OvertimeRecordList';
...
describe('OvertimeRecordList', () => {
  it('should render without crashing', () => {
    const { container } = render(<OvertimeRecordList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<OvertimeRecordList />, { wrapper });
    expect(screen.getByText('OvertimeRecord')).toBeDefined();
  });

  it('should have create button', () => {
    render(<OvertimeRecordList />, { wrapper });
    expect(screen.getByText('+ Create OvertimeRecord')).toBeDefined();
  });
