...
describe('LeaveRequestList', () => {
  it('should render without crashing', () => {
    const { container } = render(<LeaveRequestList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<LeaveRequestList />, { wrapper });
    expect(screen.getByText('LeaveRequest')).toBeDefined();
  });

  it('should have create button', () => {
    render(<LeaveRequestList />, { wrapper });
    expect(screen.getByText('+ Create LeaveRequest')).toBeDefined();
  });
