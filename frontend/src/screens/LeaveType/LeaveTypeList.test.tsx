...
describe('LeaveTypeList', () => {
  it('should render without crashing', () => {
    const { container } = render(<LeaveTypeList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<LeaveTypeList />, { wrapper });
    expect(screen.getByText('LeaveType')).toBeDefined();
  });

  it('should have create button', () => {
    render(<LeaveTypeList />, { wrapper });
    expect(screen.getByText('+ Create LeaveType')).toBeDefined();
  });
