...
describe('SalaryRecordList', () => {
  it('should render without crashing', () => {
    const { container } = render(<SalaryRecordList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<SalaryRecordList />, { wrapper });
    expect(screen.getByText('SalaryRecord')).toBeDefined();
  });

  it('should have create button', () => {
    render(<SalaryRecordList />, { wrapper });
    expect(screen.getByText('+ Create SalaryRecord')).toBeDefined();
  });
