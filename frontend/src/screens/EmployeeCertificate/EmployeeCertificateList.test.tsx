...
import { EmployeeCertificateList } from './EmployeeCertificateList';
...
describe('EmployeeCertificateList', () => {
  it('should render without crashing', () => {
    const { container } = render(<EmployeeCertificateList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<EmployeeCertificateList />, { wrapper });
    expect(screen.getByText('EmployeeCertificate')).toBeDefined();
  });

  it('should have create button', () => {
    render(<EmployeeCertificateList />, { wrapper });
    expect(screen.getByText('+ Create EmployeeCertificate')).toBeDefined();
  });
