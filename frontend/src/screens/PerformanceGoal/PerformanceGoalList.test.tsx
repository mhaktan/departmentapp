...
import { PerformanceGoalList } from './PerformanceGoalList';
...
describe('PerformanceGoalList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PerformanceGoalList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PerformanceGoalList />, { wrapper });
    expect(screen.getByText('PerformanceGoal')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PerformanceGoalList />, { wrapper });
    expect(screen.getByText('+ Create PerformanceGoal')).toBeDefined();
  });
