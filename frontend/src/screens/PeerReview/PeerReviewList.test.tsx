...
describe('PeerReviewList', () => {
  it('should render without crashing', () => {
    const { container } = render(<PeerReviewList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<PeerReviewList />, { wrapper });
    expect(screen.getByText('PeerReview')).toBeDefined();
  });

  it('should have create button', () => {
    render(<PeerReviewList />, { wrapper });
    expect(screen.getByText('+ Create PeerReview')).toBeDefined();
  });
