...
describe('OnboardingTaskList', () => {
  it('should render without crashing', () => {
    const { container } = render(<OnboardingTaskList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<OnboardingTaskList />, { wrapper });
    expect(screen.getByText('OnboardingTask')).toBeDefined();
  });

  it('should have create button', () => {
    render(<OnboardingTaskList />, { wrapper });
    expect(screen.getByText('+ Create OnboardingTask')).toBeDefined();
  });
