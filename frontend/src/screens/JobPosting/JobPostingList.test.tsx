...
describe('JobPostingList', () => {
  it('should render without crashing', () => {
    const { container } = render(<JobPostingList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<JobPostingList />, { wrapper });
    expect(screen.getByText('JobPosting')).toBeDefined();
  });

  it('should have create button', () => {
    render(<JobPostingList />, { wrapper });
    expect(screen.getByText('+ Create JobPosting')).toBeDefined();
  });
