...
import { TrainingParticipationList } from './TrainingParticipationList';
...
describe('TrainingParticipationList', () => {
  it('should render without crashing', () => {
    const { container } = render(<TrainingParticipationList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<TrainingParticipationList />, { wrapper });
    expect(screen.getByText('TrainingParticipation')).toBeDefined();
  });

  it('should have create button', () => {
    render(<TrainingParticipationList />, { wrapper });
    expect(screen.getByText('+ Create TrainingParticipation')).toBeDefined();
  });
