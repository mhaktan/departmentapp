...
describe('TrainingPlanList', () => {
  it('should render without crashing', () => {
    const { container } = render(<TrainingPlanList />, { wrapper });
    expect(container).toBeDefined();
  });

  it('should show title', () => {
    render(<TrainingPlanList />, { wrapper });
    expect(screen.getByText('TrainingPlan')).toBeDefined();
  });

  it('should have create button', () => {
    render(<TrainingPlanList />, { wrapper });
    expect(screen.getByText('+ Create TrainingPlan')).toBeDefined();
  });
